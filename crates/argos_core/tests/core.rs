//! The newtypes and the in-memory source: the two things this crate has to
//! prove on its own, with no adapter and no medium involved.

use argos_core::fixture::MemDisk;
use argos_core::{ByteOffset, Confidence, Lba, SectorRange, SectorSize};
