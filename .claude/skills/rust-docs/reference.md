# Documentation — guideline reference
...
the project's standard changes. Cite rules by id (e.g. `M-CANONICAL-DOCS`).

Rules in this file (6): `M-CANONICAL-DOCS`, `M-DOC-INLINE`, `M-DOCUMENTED-MAGIC`, `M-FIRST-DOC-SENTENCE`, `M-MODULE-DOCS`, `M-NO-META-DESIGN-DOCUMENTATION`
...
[M-NO-GLOB-REEXPORTS]: ../rust-api-surface/reference.md#M-NO-GLOB-REEXPORTS
...
Any public library module must have `//!` module documentation, and the first sentence must follow [M-FIRST-DOC-SENTENCE].
