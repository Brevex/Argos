...
the project's standard changes. Cite rules by id (e.g. `M-EXAMPLE-OVER-PROC`).

Rules in this file (7): `M-EXAMPLE-OVER-PROC`, `M-MACRO-HELPERS`, `M-MACRO-LAST-RESORT`, `M-MACRO-MAIN-CRATE`, `M-MACROS-DONT-LIE`, `M-PROC-IMPL`, `M-PROC-IMPLIED-ITEMS`
